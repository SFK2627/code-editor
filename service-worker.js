const CACHE_NAME = 'ict-8-connect-step-211';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?v=20260726-step211-label-fix',
  './index.html?fresh=step211',
  './style.css',
  './style.css?v=20260726-step211-label-fix',
  './script.js',
  './script.js?v=20260726-step211-label-fix',
  './firebase-config.js',
