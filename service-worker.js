const CACHE_NAME = 'ict8-connect-step209';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?v=20260726-step209-portrait-lock',
  './index.html?fresh=step208',
  './style.css',
  './style.css?v=20260726-step209-portrait-lock',
  './script.js',
  './script.js?v=20260726-step209-portrait-lock',
  './firebase-config.js',
