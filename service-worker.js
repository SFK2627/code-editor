const CACHE_NAME = 'mcs-coding-app-20260712-user-step89-safe-css-only-full-editor-tools';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?fresh=1',
  './style.css',
  './style.css?v=20260712-step89-safe-css-only',
  './script.js',
  './script.js?v=20260712-step89-safe-css-only',
  './firebase-config.js',
