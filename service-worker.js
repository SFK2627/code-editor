const CACHE_NAME = 'mcs-coding-app-20260712-user-step90-safe-phone-full-editor';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?fresh=1',
  './style.css',
  './style.css?v=20260712-step90-safe-phone-full-editor',
  './script.js',
  './script.js?v=20260712-step90-safe-phone-full-editor',
  './firebase-config.js',
