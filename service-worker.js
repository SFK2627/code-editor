const CACHE_NAME = 'mcs-coding-app-20260712-user-step79-centered-font-slider';
const APP_SHELL = [
  './',
  './index.html',
  './index.html?fresh=1',
  './style.css',
  './style.css?v=20260712-step79-centered-font-slider',
  './script.js',
  './script.js?v=20260712-step79-centered-font-slider',
  './firebase-config.js',
